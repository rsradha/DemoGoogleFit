package com.radha.DemoGoogleFit;
...
public class MainActivity extends AppCompatActivity implements OnDataPointListener,
    ...
    @Override
    public void onConnected(@Nullable Bundle bundle, DataSourcesRequest dataSourceRequest) {
    ...
    @Override //to disconnect from Google Play Services
